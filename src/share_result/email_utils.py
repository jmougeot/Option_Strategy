...
from share_result.utils import EmailTemplateData
from share_result.generate_email import (open_outlook_with_email,)
...
def build_email_template_data(
    ...
    comparisons_list = comparisons or []
    if not comparisons_list and multi_ranking and hasattr(multi_ranking, 'all_strategies_flat'):
    ...
    future_data_email = future_data or FutureData(None, None)
...
def create_email_with_images(
    ...
    """
    from share_result.image_saver import save_payoff_single_strategy
