...
from myproject.app.processing import process_comparison_results, save_to_session_state, display_success_stats
...
def main():
    ...
    comparisons, top_5_comparisons, best_target_price = process_comparison_results(all_comparisons)
