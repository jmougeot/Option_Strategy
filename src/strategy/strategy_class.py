...
@dataclass
class StrategyComparison(BaseStrategy):
    """Résultat de comparaison d'une stratégie (issu du générateur de ranking).
    Hérite de BaseStrategy : name, legs (List[Option]), total_delta, total_gamma, total_theta.
    """
    _: KW_ONLY
    legs: List[Option]  # Les options constituant la stratégie – override de la base
    premium: float
    ...
    # total_delta, total_gamma, total_theta hérités de BaseStrategy
