...
from strategy.batch_processor import (process_batch_cpp_with_multi_scoring,init_cpp_cache,)
from app.data_types import FilterData

def sort_options_by_expiration(options: List[Option]) -> List[Option]:
    """
    Trie les options par date d'expiration (annee > mois > semaine > jour).
    """
    ...
    def expiration_key(opt: Option):
        ...
        try:
            ...
            month_index = -1  # si valeur inattendue, met � la fin
